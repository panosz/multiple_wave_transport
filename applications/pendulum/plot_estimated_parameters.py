...
FIGURE_FOLDER = THIS_FOLDER / "figures"/ "single_wave" 
...
ax.plot(df.amplitude, df.A_steady*df.alpha_steady, 'r--o')
ax.set_ylabel(r"$A\alpha$")
ax.set_xlabel("amplitude")


fig, ax = plt.subplots(1,1, figsize=(8, 6), constrained_layout=True)
ax.plot(df.amplitude, df.S0/df.A_steady, 'r--o')
ax.plot(df.amplitude, df.S1/df.A_steady, 'b--o')
